...
$query = "UPDATE manual_updates SET lat='$lat', lng='$lng', category_1='$category_1', category_2='$category_2', category_3='$category_3', category_4='$category_4' WHERE link='$link'";
echo $query; 
