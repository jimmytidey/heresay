...
<div class='container'>
    ...
    <div class='row'>
        ...
        <div class='span3'>
            ...
            <h3 id='blog_link'><a href='/'>Main site </a></h3>  
        </div>    
        ...
        <div class='span10' >
            ...
            <?  $end    = 1372654800;
                ...
                if (empty($ward)) {
                    ...
                    $query = "SELECT *, manual_updates.lat as manual_updates_lat, manual_updates.lng  as manual_updates_lng from manual_updates JOIN manual_sites ON manual_updates.site = manual_sites.site 
