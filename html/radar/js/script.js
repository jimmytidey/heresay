$(document).ready(function(){
    $('#filter_by_borough').change(function(){ 
       ...
       if(search_val == 'Hackney') { 
           var lat = 51.54420497912117;
           var lng =-0.054214999999999236; 
       }
       
       else if (search_val == 'Tower Hamlets') { 
           var lat = 51.51515452914685;
           var lng =-0.034831199999985074;           
       }
       ...
       $.get('/api/get_updates.php?lat=' + lat + '&lng=' +  lng, function(data){
           ...
           $.each(data['results'], function(key, val){
               console.log(val);
                ...
                html += "<h3><a href='" + val.link + "'>" + val.title + "</a></h3>";
